                            ...
                            <form class="form-horizontal" action="editServlet" method="POST">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                  <input type="text" name="description" class="form-control" value="${pro.des}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-line">
                                                <select name="categoryId">
                                                    <c:forEach var="temp" items="${listCate}">
                                                        <c:choose>
                                                            <c:when test="${temp.cateName == pro.category.getCateName()}">
                                                                <option value="${temp.idCate}" selected="selected">
                                                                    ${temp.cateName}
                                                                </option>
                                                            </c:when>
                                                            <c:otherwise>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" name="quantity" class="form-control" value="${pro.quantity}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" name="unitPrice" class="form-control" value="${pro.unitPrice}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
